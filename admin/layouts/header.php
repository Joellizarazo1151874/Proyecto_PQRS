  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link">
      <img src="../images/default.png" alt="ufps Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">UFPS PQRS</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="../fotosPerfil/<?php echo $arregloUsuario['imagen']; ?>" class="img-circle elevation-2" alt="<?php echo $arregloUsuario['nombre']; ?>">
        </div>
        <div class="info">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="activasAdmin.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Activas</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="enEsperaAdmin.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>En espera</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="anonimas.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Anonimas</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="realizarPqrs.php" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="activasUsuario.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Activas</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="enEsperaUsuario.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>En espera</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="resueltasUsuario.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Resueltas</p>
                </a>
              </li>
