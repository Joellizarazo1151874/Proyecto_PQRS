          ...
          <div class="card card-primary card-outline" style="border-top-color:#C20000">
            ...
            <div class="card-body p-0">
              <div class="mailbox-controls">
                ...
                <!-- /.btn-group -->
                <a type="button" href="resueltasUsuario.php" class="btn btn-default btn-sm">
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                    ...
                    <td class="mailbox-name"><a href="leerResueltaUsuario.php?id=<?php echo $f['id_pqrs']; ?>" class="h8" style="color: #000;">Admin</a></td>
                    <td class="mailbox-subject"><b class="h10" >Respuesta:</b> <?php echo $f['asuntoResU']; ?>
                    </td>
