<?php  
  ...
  $resultado = $conexion ->query("select 
    ...
    inner join usuario on pqrs.id_usuario = usuario.id where estado='en espera'
  ...
  $resultado2 = $conexion ->query("select 
    ...
    inner join pqrs on resusuario.id_pqrs = pqrs.id where estado='en tramite' && pqrs.id_usuario='".$arregloUsuario['id_usuario']."'
    order by id ASC")or die($conexion->error);
  ?>
          ...
          <div class="card card-primary card-outline" style="border-top-color:#C20000">
            ...
            <div class="card-body p-0">
              <div class="mailbox-controls">
                ...
                <!-- /.btn-group -->
                <a type="button" href="enEsperaAdmin.php" class="btn btn-default btn-sm">
                  <i class="fas fa-sync-alt"></i>
                </a>
                <a href="resueltosAdmin.php" type="button" class=" badge-info btn btn-default btn-sm"><i class="fas fa-share"></i> Resueltos</a>
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                    ...
                    <td class="mailbox-name"><a class="h8" style="color: #000;" href="leerEnEspera.php?id=<?php echo $f['id']; ?>"><?php echo $f['nombre']; ?></a></td>
                  ...
                  <tr>
                    ...
                    <td class="mailbox-name"><a class="h8" style="color: #000;" href="leerEnEspera.php?id=<?php echo $a['id']; ?>"><?php echo $a['nombre']; ?></a></td>
                    <td class="mailbox-subject"><b class="h10" >Asunto</b> - <?php echo $a['asunto']; ?>
                    </td>
                    <td class="mailbox-subject"><?php echo $a['tipo_solicitud']; ?> - <span class="badge badge-info"><?php echo $a['estado']; ?></span>
                    </td>
                      <td class="mailbox-attachment">

                    <button class="btn btn-info position-relative" data-toggle="dropdown" href="#">
                        ...
                        <a href="#" class="dropdown-item">
                          ...
                          <div class="media">
                            ...
                            <div class="media-body">
                              ...
                              <p class="text-sm"><?php echo $a['noSolucion']; ?></p>
                              <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i> <?php echo $hora1; ?></p>
                            </div>
                          </div>
                          <!-- Message End -->
                        </a>
