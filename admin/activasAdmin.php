<?php  
  ...
  $resultado = $conexion ->query("select 
    ...
    inner join usuario on pqrs.id_usuario = usuario.id where estado='activo'
          ...
          <div class="card card-primary card-outline" style="border-top-color:#C20000">
            ...
            <div class="card-body p-0">
              <div class="mailbox-controls">
                ...
                <!-- /.btn-group -->
                <a type="button" href="activasAdmin.php" class="btn btn-default btn-sm">
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                    ...
                    <td class="mailbox-name"><a class="h8" style="color: #000;" href="leerPqrs.php?id=<?php echo $f['id']; ?>"><?php echo $f['nombre']; ?></a></td>
