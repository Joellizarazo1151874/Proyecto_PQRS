  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        ...
        ?>
          <div class="col-sm-6">
            <h1 class="card-title">Estado <span class="badge badge-warning"><?php echo $f['estado']; ?></span></h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="card card-primary card-outline" style="border-top-color:#C20000">
            <div class="card-header">
              ...
              <div class="card-tools">
                ...
                <a href="enEsperaAdmin.php" type="button" class="btn btn-default btn"><i class="fas fa-reply"></i> Volver</a>

                <button data-toggle="modal" data-target="#modaResponder" type="button" class="btn btn-default btnResponder"
                data-id="<?php echo $r['id']; ?>"
                data-espera="<?php echo $r['espera']; ?>"
                ><i class="fas fa-share"></i> Resolver</button>
              </div>
              </div>
            </div>
            <!-- /.card-header -->
              ...
              <ul class="mailbox-attachments d-flex align-items-stretch clearfix">
                ...
                <li>
                  ...
                  <div class="mailbox-attachment-info">
                    <a href="archivos/<?php echo $f['ruta']; ?>" class="mailbox-attachment-name" target="_blank"><br><i class="fas fa-camera"></i> <?php echo $f['nombre_archivo']; ?></a>
                ...
                ?>
                  <div class="mailbox-attachment-info">
                    <a href="archivos/<?php echo $f['ruta']; ?>" target="_blank" class="mailbox-attachment-name"><br><i class="fas fa-paperclip"></i> <?php echo $f['nombre_archivo']; ?></a>
                        <span class="mailbox-attachment-size clearfix mt-1">
                          <span><?php echo $f['peso']; ?> KB</span>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                      <label for="asuntoEdit">Asunto:</label>
                      <input type="text" name="asuntoResU" id="asuntoEdit" placeholder="espera" class="form-control" required value="Su <?php echo $f['tipo_solicitud']; ?> <?php echo $r['asuntoRes']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="respuestaEdit">Mensaje:</label>
                      <textarea type="text" name="respuestaU" id="respuestaEdit" placeholder="Escriba aqui la respuesta" class="form-control"></textarea>
                    </div>
                    <div class="form-group">
                      <label for="imagen">Seleccione Archivo si es necesario</label>
                      <input type="file" name="imagen" id="imagen" class="form-control">
                    </div>
                  </div>
                  <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                    <button type="submit" class="btn btn-info enviar">Enviar</button>
                  </div>
                  </form>
                </div>
              </div>
