<?php  
  ...
  if (isset($_GET['id'])) {
    ...
    * from pqrs where pqrs.id=".$_GET['id'])or die($conexion->error);
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        ...
        ?>
          <div class="col-sm-6">
            <h1 class="card-title">Estado <span class="badge badge-danger"><?php echo $f['estado']; ?></span></h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="card card-primary card-outline" style="border-top-color:#C20000">
            <div class="card-header">
              ...
              <div class="card-tools">
                ...
                <?php if ($f['estado']=='anonimo') {
                  // code...
                ?>
                <a href="anonimas.php" type="button" class="btn btn-default btn"><i class="fas fa-reply"></i> Volver</a>
                ...
                ><i class="fas fa-share"></i> Visto</button>
                <?php }else{ ?>
                  <a href="anonimosRes.php" type="button" class="btn btn-default btn"><i class="fas fa-reply"></i> Volver</a>
                <?php } ?>
                </div>
              </div>
            </div>
            ...
            <div class="card-body p-0">
              <div class="mailbox-read-info">
                <h5><b><?php echo $f['estado']; ?></b>
                  <span  style="color:#444" class="mailbox-read-time float-right"><?php echo $f['fecha']; ?></span></h5>
                <h8 style="color:#444"></h8>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-header">
                    <h5 class="modal-title" id="modalResponderLabel">¿Estas seguro?</h5>
                  ...
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                      <label for="esperaEdit">Esta <?php echo $f['tipo_solicitud']; ?> sera marcada como revisada</label>
                      <input type="hidden" name="revisado" id="esperaEdit" placeholder="revisado" class="form-control" value="revisado">
                    </div>

                  </div>
                  <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                    <button type="submit" class="btn btn-danger enviar">Revisado</button>
                  </div>
                  </form>
                </div>
              </div>
