<?php  
  ...
  $resultado = $conexion ->query("select * from pqrs where estado='anonimo'
          ...
          <div class="card card-primary card-outline" style="border-top-color:#C20000">
            ...
            <div class="card-body p-0">
              <div class="mailbox-controls">
                ...
                <a href="anonimosRes.php" type="button" class=" badge-danger btn btn-default btn-sm"><i class="fas fa-share"></i> Vistos</a>
