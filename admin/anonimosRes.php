<?php  
  ...
  $resultado = $conexion ->query("select * from pqrs where estado='revisado'
          ...
          <div class="card card-primary card-outline" style="border-top-color:#C20000">
            ...
            <div class="card-body p-0">
              <div class="mailbox-controls">
                ...
                <!-- /.btn-group -->
                <a type="button" href="anonimas.php" class="btn btn-default btn-sm">
                  <i class="fas fa-sync-alt"></i>
                </a>
                <a href="anonimas.php" type="button" class=" badge-danger btn btn-default btn-sm"><i class="fas fa-share"></i> Volver</a>
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                    ...
                    <td class="mailbox-name"><a class="h8" style="color: #000;" href="leerAnonimo.php?id=<?php echo $f['id']; ?>"><?php echo $f['estado']; ?></a></td>
                    <td class="mailbox-subject"><b class="h10" >Asunto</b> - <?php echo $f['asunto']; ?>
                    </td>
                    <td class="mailbox-subject"><?php echo $f['tipo_solicitud']; ?> - <span class="badge badge-danger"><?php echo $f['estado']; ?></span>
                    </td>
